...
class ApiService {
  ...
  public static init(app: App<Element>) {
    ...
    ApiService.vueInstance.axios.defaults.baseURL = "https://mexoapi.azurewebsites.net/";
  // ApiService.vueInstance.axios.defaults.baseURL = "http://localhost:8080";
  }
  ...
  public static setHeader(): void {
   /*  ApiService.vueInstance.axios.defaults.headers.common[
    ...
    console.log("Token From JWT Service -- " + JwtService.getToken());
    ApiService.vueInstance.axios.defaults.headers.common[
      "Authorization"
   ...
   * @returns {*}
   */
   public static postauth(resource) {
